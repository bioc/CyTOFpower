...
by thefold change defined earlier: $\mu_{1,ij}= \mu_{0,ij} \cdot \rho_j$.
...
data and the power is computated on request based on the parameters chosen by
the user.
