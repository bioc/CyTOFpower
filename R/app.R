mylist <-list(
  "nb_donor" = c(5, 10, 20, 30, NA), #c(3, 5, 10, 20, 30, 40, 50, NA),
  "total_nb_markers" = c(10, 20, 30, 40, NA), #c(10, 20, 30, 40, 50, 60),
  "nb_DEmarkers" = 7,
  "subject_effect" = c(0.1, 0.5, NA),  #c(seq(0.1, 1, by = 0.2), NA),
  "mu0" = c(seq(1, 10, by = 2), NA), #c(1:10, NA),
  "dispersion" = c(seq(0.5, 4, by = 1), NA), #by = 0.5
  "nb_cell_per_sample" = c(1000, 5000, 10000, 20000, NA)  #c(500, 1000, 2000, 5000, 10000, 15000, 20000, NA)
)
